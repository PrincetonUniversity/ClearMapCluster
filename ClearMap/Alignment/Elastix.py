...
def initializeElastix(path = None):
    ...
    #TP MODIFYING FOR CLUSTER
    #elif os.path.exists(path):
    #    ElastixBinary = os.path.join(path, 'elastix');
    #    print ('setting elastix path as {}, note this is a hack and may fail'.format(ElastixBinary))
    else:
    ...
    #TP MODIFYING FOR CLUSTER
    #elif os.path.exists(path):
    #    TransformixBinary = os.path.join(path, 'transformix');
    #    print ('setting elastix path as {}, note this is a hack and may fail'.format(TransformixBinary))
    else:
    ...
    #TP MODIFYING FOR CLUSTER    
        ...
        print ('setting elastixlib path as {}, ***note this is a hack and may fail***'.format(ElastixLib))
    else:
...
def alignData(fixedImage, movingImage, affineParameterFile, bSplineParameterFile = None, resultDirectory = None):
    ...
    if bSplineParameterFile is None:
        ...
        sp.call(['elastix', '-m', movingImage, '-f', fixedImage, '-p', affineParameterFile, '-out', resultDirectory]);
